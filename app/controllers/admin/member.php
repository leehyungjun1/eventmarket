...
class member extends admin_base {
	...
	### 회원상세 (->/admincrm/main/user_detail)
	public function detail()
	{
		...
		redirect("/admincrm/main/user_detail?member_seq=".$member_seq);//@2016-06-01 crm page
	}
...
{bank_account}  {settleprice}";
		...
		$use_replace_code = [
			...
			'released' =>  ['shopName', 'shopDomain', 'ordno', 'go_item', 'delivery_company', 'delivery_number', 'userid', 'order_user', 'recipient_user', 'username'], // 출고완료(주문자) 시
			'released2' =>  ['shopName', 'shopDomain', 'ordno', 'go_item', 'delivery_company', 'delivery_number', 'userid', 'order_user', 'recipient_user', 'username'], // 출고완료(받는분) 시
			'delivery' =>  ['shopName', 'shopDomain', 'ordno', 'go_item', 'userid', 'order_user', 'recipient_user', 'username'], // 배송완료(주문자) 시
			'delivery2' =>  ['shopName', 'shopDomain', 'ordno', 'go_item', 'userid', 'order_user', 'recipient_user', 'username'], // 배송완료(받는분) 시
			...
			'coupon_released' => ['shopName', 'shopDomain', 'coupon_serial', 'couponNum', 'coupon_value', 'options', 'goods_name', 'userid', 'order_user', 'recipient_user', 'username'], // 티켓발송(받는분)
			'coupon_released2' => ['shopName', 'shopDomain', 'coupon_serial', 'couponNum', 'coupon_value', 'options', 'goods_name', 'userid', 'order_user', 'recipient_user', 'username'], // 티켓발송(주문자)
			...
			'coupon_delivery' => ['shopName', 'shopDomain', 'coupon_serial', 'couponNum', 'coupon_value', 'options', 'used_time', 'coupon_used', 'coupon_remain', 'used_location', 'confirm_person', 'goods_name', 'userid', 'order_user', 'username'], //티켓사용(받는분)
			'coupon_delivery2' => ['shopName', 'shopDomain', 'coupon_serial', 'couponNum', 'coupon_value', 'options', 'used_time', 'coupon_used', 'coupon_remain', 'used_location', 'confirm_person', 'goods_name', 'userid', 'order_user', 'username'], //티켓사용(주문자)
